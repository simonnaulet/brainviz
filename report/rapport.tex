...
\begin{quote}
\textbf{Archive exploratoire.} Ce rapport décrit l'ancien pipeline Compact
U-Net. Ses premiers scores reposent sur une agrégation du Dice par batch qui
les surestime et ne doivent pas être comparés au protocole Rep-SliceMix. Les
résultats de référence sont centralisés dans
